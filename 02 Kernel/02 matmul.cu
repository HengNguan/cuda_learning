...
/*
Note, even the data is stored in 1D, the computation is still done in 2D.
CUDA computation -> not how the memory is stored, but where the computation is happened.
